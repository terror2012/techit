    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="dropdown">
                ...
                <button id="clientBT" class="btn btn-default dropdown-toggle" type="button" id="client" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    Client Type
            ...
            <div class="dropdown">
                ...
                <button id="contactBT" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            ...
            <div class="dropdown">
                ...
                <button id="stateBT" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    Select The State
                    <span class="caret"></span>
                </button>
                <ul class="dropdown-menu text-center" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
            ...
            <div class="dropdown">
                ...
                <button id="dateBT" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    Select The Date
                    <span class="caret"></span>
                </button>
                <ul class="dropdown-menu text-center" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
            ...
            <div class="dropdown">
                ...
                <button id="timeBT" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    Select The Time
                    <span class="caret"></span>
                </button>
                <ul class="dropdown-menu text-center" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
