                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-10" id="tourpackages-carousel">
                            <!-- Title -->
                            <form action="{{url('/admin/how_to/add')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
...
<!-- Description -->
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="description" id="exampleTextarea" rows="8"></textarea>
  </div>         
