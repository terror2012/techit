...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="item">
                <a href="index.html"><span class="glyphicon glyphicon-chevron-left"></span> Back</a>
            </li>

            <hr />
            <li class="item">
                <a href="index.html">General Settings</a>

            </li>
            <li class="item">
                <a href="index.html">HowTo Settings</a>

            </li>
            <li class="item">
                <a href="index.html">Schedule Settings</a>

            </li>
            <li class="item">
                <a href="index.html">Gallery Settings</a>
