    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1><span class="glyphicon glyphicon-eye-open"></span> View Archieved invoice</h1>
                    <hr />
                    ...
                    <hr />
                    <h2><strong>Status:   </strong>   {{$invoice['status']}}  </h2>
                    <hr />
                    <h2><strong>Invoice Sent:</strong>      {{$invoice['invoice_sent']}}  </h2>
                    <hr />
                    <h2><strong>Reminders:   </strong>   {{$invoice['reminders']}}  </h2>
                    <hr />
                    <h2><strong>Created_At:  </strong>   {{$invoice['solved_at']}}   </h2>
                    <hr />
                </div>
            </div>
        </div>
